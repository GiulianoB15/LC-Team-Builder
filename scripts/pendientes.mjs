...
Poder base, monedas y valor de moneda: **${skills.length - skillsSinNumeros.length} de ${skills.length}**.${
      skillsSinNumeros.length
        ? `\n\nLos ${skillsSinNumeros.length} que faltan quedan en \`null\`, nunca en cero, para que se note que es un
dato que falta y no un valor real.`
